...
#c.JupyterHub.data_files_path = '/root/anaconda2/envs/venv/share/jupyterhub'
...
#c.JupyterHub.ssl_cert = '/etc/ssl/certs/ssl.crt'

## Path to SSL key file for the public facing interface of the proxy
#  
#  When setting this, you should also set ssl_cert
#c.JupyterHub.ssl_key = '/etc/ssl/certs/ssl.key'
...
c.PAMAuthenticator.delete_invalid_users = True
